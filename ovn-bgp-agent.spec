...
%changelog
* Fri Jul 25 2025 RDO <dev@lists.rdoproject.org> 1:2.1.0-1
- Update to 2.1.0

* Wed Apr 03 2024 RDO <dev@lists.rdoproject.org> 1:2.0.1-1
- Update to 2.0.1

* Thu Mar 28 2024 RDO <dev@lists.rdoproject.org> 1:2.0.0-0.2.0rc1
- Update to 2.0.0.0rc2

* Thu Mar 14 2024 RDO <dev@lists.rdoproject.org> 1:2.0.0-0.1.0rc1
